...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/insights/data-collection-endpoint:<version>`.
...
```bicep
module dataCollectionEndpointMod 'br/<registry-alias>:res/insights/data-collection-endpoint:<version>' = {
  name: 'dataCollectionEndpoint-mod'
  params: {
    // Required parameters
    name: 'idcemin001'
...
```bicep-params
using 'br/public:res/insights/data-collection-endpoint:<version>'
