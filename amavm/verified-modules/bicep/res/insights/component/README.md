...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/insights/component:<version>`.
...
```bicep
module componentMod 'br/<registry-alias>:res/insights/component:<version>' = {
  name: 'component-mod'
  params: {
    // Required parameters
    name: 'icmin001'
...
```bicep-params
using 'br/public:res/insights/component:<version>'
...
| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`applicationType`](#parameter-applicationtype) | string | Application type. Default is set to 'web' |
| [`diagnosticSettings`](#parameter-diagnosticsettings) | array | The diagnostic settings of the service.<p><p>Use of any of the following categories will make this resource non-compliant: "AppEvents", "AppExceptions", "AppRequests", "AppTraces"<p> |
| [`disableIpMasking`](#parameter-disableipmasking) | bool | Disable IP masking. Default value is set to true. |
| [`disableLocalAuth`](#parameter-disablelocalauth) | bool | Disable Non-AAD based Auth. Default value is set to true.<p> |
| [`enableTelemetry`](#parameter-enabletelemetry) | bool | Enable/Disable usage telemetry for module. |
| [`forceCustomerStorageForProfiler`](#parameter-forcecustomerstorageforprofiler) | bool | Force users to create their own storage account for profiler and debugger. Default is set to false. |
| [`immediatePurgeDataOn30Days`](#parameter-immediatepurgedataon30days) | bool | Purge data immediately after 30 days.  Default is set to false. |
| [`kind`](#parameter-kind) | string | The kind of application that this component refers to, used to customize UI.<p>This value is a freeform string, values should typically be one of the following: web, ios, other, store, java, phone. Default is set to 'web'<p> |
...
| [`publicNetworkAccessForIngestion`](#parameter-publicnetworkaccessforingestion) | string | The network access type for accessing Application Insights ingestion. - Enabled or Disabled. Default is Enabled. |
| [`publicNetworkAccessForQuery`](#parameter-publicnetworkaccessforquery) | string | The network access type for accessing Application Insights query. - Enabled or Disabled. Default is Enabled. |
| [`retentionInDays`](#parameter-retentionindays) | int | Retention period in days. Default is 365. |
| [`roleAssignments`](#parameter-roleassignments) | array | Array of role assignments to create. |
| [`samplingPercentage`](#parameter-samplingpercentage) | int | Percentage of the data produced by the application being monitored that is being sampled for Application Insights telemetry. Default is 100. |
...
Application type. Default is set to 'web'
...
The diagnostic settings of the service.<p><p>Use of any of the following categories will make this resource non-compliant: "AppEvents", "AppExceptions", "AppRequests", "AppTraces"<p>
...
Disable Non-AAD based Auth. Default value is set to true.<p>
...
Force users to create their own storage account for profiler and debugger. Default is set to false.
...
Purge data immediately after 30 days.  Default is set to false.
...
The kind of application that this component refers to, used to customize UI.<p>This value is a freeform string, values should typically be one of the following: web, ios, other, store, java, phone. Default is set to 'web'<p>
...
The network access type for accessing Application Insights ingestion. - Enabled or Disabled. Default is Enabled.
...
The network access type for accessing Application Insights query. - Enabled or Disabled. Default is Enabled.
...
Retention period in days. Default is 365.
...
Percentage of the data produced by the application being monitored that is being sampled for Application Insights telemetry. Default is 100.
