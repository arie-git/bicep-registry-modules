...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/insights/activity-log-alert:<version>`.
...
```bicep
module activityLogAlertMod 'br/<registry-alias>:res/insights/activity-log-alert:<version>' = {
  name: 'activityLogAlert-mod'
  params: {
    // Required parameters
    conditions: [
      {
...
```bicep-params
using 'br/public:res/insights/activity-log-alert:<version>'
