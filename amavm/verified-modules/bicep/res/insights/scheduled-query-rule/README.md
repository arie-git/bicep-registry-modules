...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/insights/scheduled-query-rule:<version>`.
...
```bicep
module scheduledQueryRuleMod 'br/<registry-alias>:res/insights/scheduled-query-rule:<version>' = {
  name: 'scheduledQueryRule-mod'
  params: {
    // Required parameters
    criterias: {
      allOf: [
...
```bicep-params
using 'br/public:res/insights/scheduled-query-rule:<version>'
