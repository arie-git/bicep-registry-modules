...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/insights/data-collection-rule:<version>`.
...
```bicep
module dataCollectionRuleMod 'br/<registry-alias>:res/insights/data-collection-rule:<version>' = {
  name: 'dataCollectionRule-mod'
  params: {
    // Required parameters
...
```bicep-params
using 'br/public:res/insights/data-collection-rule:<version>'
