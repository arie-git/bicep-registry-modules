...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/insights/action-group:<version>`.
...
```bicep
module actionGroupMod 'br/<registry-alias>:res/insights/action-group:<version>' = {
  name: 'actionGroup-mod'
  params: {
    // Required parameters
...
```bicep-params
using 'br/public:res/insights/action-group:<version>'
