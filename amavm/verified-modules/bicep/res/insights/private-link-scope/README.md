...
| `Microsoft.Insights/privateLinkScopes` | 2023-06-01-preview | <ul style="padding-left: 0px;"><li>[AzAdvertizer](https://www.azadvertizer.net/azresourcetypes/microsoft.insights_privatelinkscopes.html)</li><li>[Template reference](https://learn.microsoft.com/en-us/azure/templates/Microsoft.Insights/2023-06-01-preview/privateLinkScopes)</li></ul> |
...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/insights/private-link-scope:<version>`.
...
```bicep
module privateLinkScopeMod 'br/<registry-alias>:res/insights/private-link-scope:<version>' = {
  name: 'privateLinkScope-mod'
  params: {
    // Required parameters
    name: 'iplsmin001'
...
```bicep-params
using 'br/public:res/insights/private-link-scope:<version>'
