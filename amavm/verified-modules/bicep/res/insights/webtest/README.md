...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/insights/webtest:<version>`.
...
```bicep
module webtestMod 'br/<registry-alias>:res/insights/webtest:<version>' = {
  name: 'webtest-mod'
  params: {
    // Required parameters
...
```bicep-params
using 'br/public:res/insights/webtest:<version>'
