...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/insights/diagnostic-setting:<version>`.
...
```bicep
module diagnosticSettingMod 'br/<registry-alias>:res/insights/diagnostic-setting:<version>' = {
  name: 'diagnosticSetting-mod'
  params: {
    location: '<location>'
    name: 'idsmin001'
...
```bicep-params
using 'br/public:res/insights/diagnostic-setting:<version>'
