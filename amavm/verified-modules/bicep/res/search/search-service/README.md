...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/search/search-service:<version>`.

- [Private endpoint-enabled deployment](#example-1-private-endpoint-enabled-deployment)
- [Using large parameter set](#example-2-using-large-parameter-set)
- [WAF-aligned](#example-3-waf-aligned)

### Example 1: _Private endpoint-enabled deployment_
...
```bicep
module searchServiceMod 'br/<registry-alias>:res/search/search-service:<version>' = {
  name: 'searchService-mod'
  params: {
    // Required parameters
    name: 'ssspr001'
    privateEndpoints: [
...
```bicep-params
using 'br/public:res/search/search-service:<version>'
...
| [`dataExfiltrationProtections`](#parameter-dataexfiltrationprotections) | array | A list of data exfiltration scenarios that are explicitly disallowed for the search service. Default [`All`]<p><p>Setting this parameter to any other value will make the resource non-compliant.<p> |
| [`diagnosticSettings`](#parameter-diagnosticsettings) | array | The diagnostic settings of the service.<p><p>Currently known available log categories are:<p>  'OperationLogs'<p> |
| [`disableLocalAuth`](#parameter-disablelocalauth) | bool | When set to true, calls to the search service will not be permitted to utilize API keys for authentication. This cannot be set to true if \'authOptions\' are defined.<p><p>Setting this parameter to 'False' will make the resource non-compliant.<p> |
...
| [`publicNetworkAccess`](#parameter-publicnetworkaccess) | string | If set to \'Disabled\', traffic over public interface is not allowed, and private endpoint connections would be the exclusive access method.<p><p>Setting this parameter to 'Enabled' will make the resource non-compliant.<p> |
...
| [`sharedPrivateLinkResources`](#parameter-sharedprivatelinkresources) | array | The sharedPrivateLinkResources to create as part of the search Service. These are managed private endpoints to support private access to other resources in your subscription. Your request must be approved by the resource owner before you can connect. |
...
A list of data exfiltration scenarios that are explicitly disallowed for the search service. Default [`All`]<p><p>Setting this parameter to any other value will make the resource non-compliant.<p>
...
The diagnostic settings of the service.<p><p>Currently known available log categories are:<p>  'OperationLogs'<p>
...
When set to true, calls to the search service will not be permitted to utilize API keys for authentication. This cannot be set to true if \'authOptions\' are defined.<p><p>Setting this parameter to 'False' will make the resource non-compliant.<p>
...
If set to \'Disabled\', traffic over public interface is not allowed, and private endpoint connections would be the exclusive access method.<p><p>Setting this parameter to 'Enabled' will make the resource non-compliant.<p>
...
The sharedPrivateLinkResources to create as part of the search Service. These are managed private endpoints to support private access to other resources in your subscription. Your request must be approved by the resource owner before you can connect.
