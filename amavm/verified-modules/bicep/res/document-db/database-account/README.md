...
This module deploys an Azure Cosmos DB account. Only the NoSQL API is enabled per company policy.
...
Compliant usage of Azure Cosmos DB requires:
...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/document-db/database-account:<version>`.

- [Cosmos DB - Defaults](#example-1-cosmos-db---defaults)
- [Cosmos DB - Maximum](#example-2-cosmos-db---maximum)
- [Cosmos DB - WAF-aligned](#example-3-cosmos-db---waf-aligned)

### Example 1: _Cosmos DB - Defaults_

This test deploys a Cosmos DB account with default (NoSQL) configuration and private endpoint (public network access denied by policy).
...
```bicep
module databaseAccountMod 'br/<registry-alias>:res/document-db/database-account:<version>' = {
  name: 'databaseAccount-mod'
  params: {
    // Required parameters
    name: '<name>'
    privateEndpoints: [
...
```bicep-params
using 'br/public:res/document-db/database-account:<version>'
...
### Example 2: _Cosmos DB - Maximum_

This test deploys a Cosmos DB account exercising the maximum number of parameters.
...
// Non-required parameters
param backupPolicyContinuousTier = 'Continuous30Days'
...
param enableBurstCapacity = true
param enableFreeTier = false
param enableMultipleWriteLocations = false
param enablePartitionMerge = false
param enablePerRegionPerPartitionAutoscale = false
...
param totalThroughputLimit = -1
```

</details>
<p>

### Example 3: _Cosmos DB - WAF-aligned_

This test deploys a Cosmos DB account in alignment with the best practices of the Azure Well-Architected Framework.
...
| [`capabilitiesToAdd`](#parameter-capabilitiestoadd) | array | A list of Azure Cosmos DB specific capabilities for the account. [Policy: drcp-cosmos-06] |
| [`cors`](#parameter-cors) | object | The CORS policy for the Cosmos DB database account. |
...
| [`disableKeyBasedMetadataWriteAccess`](#parameter-disablekeybasedmetadatawriteaccess) | bool | Disable write operations on metadata resources (databases, containers, throughput) via account keys. Defaults to true. [Policy: drcp-cosmos-03] |
| [`disableLocalAuthentication`](#parameter-disablelocalauthentication) | bool | Opt-out of local authentication and ensure that only Microsoft Entra can be used exclusively for authentication. Defaults to true. [Policy: drcp-cosmos-02] |
...
| [`failoverLocations`](#parameter-failoverlocations) | array | The set of locations enabled for the account. Defaults to the location where the account is deployed. [Policy: drcp-cosmos-10] |
...
| [`minimumTlsVersion`](#parameter-minimumtlsversion) | string | Setting that indicates the minimum allowed TLS version. Defaults to "Tls12" (TLS 1.2). [Policy: drcp-cosmos-05] |
| [`networkRestrictions`](#parameter-networkrestrictions) | object | The network configuration of this module. Defaults to `{ ipRules: [], virtualNetworkRules: [], publicNetworkAccess: 'Disabled' }`. [Policy: drcp-cosmos-01] |
| [`privateEndpoints`](#parameter-privateendpoints) | array | Configuration details for private endpoints. For security reasons, it is advised to use private endpoints whenever possible. [Policy: drcp-sub-07] |
...
| [`zoneRedundant`](#parameter-zoneredundant) | bool | Indicates whether the single-region account is zone redundant. Defaults to true. This property is ignored for multi-region accounts. [Policy: drcp-cosmos-10] |
...
A list of Azure Cosmos DB specific capabilities for the account. [Policy: drcp-cosmos-06]
...
Disable write operations on metadata resources (databases, containers, throughput) via account keys. Defaults to true. [Policy: drcp-cosmos-03]
...
Opt-out of local authentication and ensure that only Microsoft Entra can be used exclusively for authentication. Defaults to true. [Policy: drcp-cosmos-02]
...
The set of locations enabled for the account. Defaults to the location where the account is deployed. [Policy: drcp-cosmos-10]
...
Setting that indicates the minimum allowed TLS version. Defaults to "Tls12" (TLS 1.2). [Policy: drcp-cosmos-05]
...
The network configuration of this module. Defaults to `{ ipRules: [], virtualNetworkRules: [], publicNetworkAccess: 'Disabled' }`. [Policy: drcp-cosmos-01]
...
Configuration details for private endpoints. For security reasons, it is advised to use private endpoints whenever possible. [Policy: drcp-sub-07]
...
Indicates whether the single-region account is zone redundant. Defaults to true. This property is ignored for multi-region accounts. [Policy: drcp-cosmos-10]
...
| `evidenceOfNonCompliance` | bool | Is there evidence of usage in non-compliance with policies? Checks: drcp-cosmos-01 (publicNetworkAccess), drcp-cosmos-02 (disableLocalAuth), drcp-cosmos-03 (disableKeyBasedMetadataWriteAccess), drcp-cosmos-05 (minimumTlsVersion), drcp-cosmos-10 (zoneRedundant). |
