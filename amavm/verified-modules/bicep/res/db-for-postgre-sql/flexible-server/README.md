...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/db-for-postgre-sql/flexible-server:<version>`.
...
```bicep
module flexibleServerMod 'br/<registry-alias>:res/db-for-postgre-sql/flexible-server:<version>' = {
  name: 'flexibleServer-mod'
  params: {
    // Required parameters
    availabilityZone: 1
    name: 'dfpsmin001'
...
```bicep-params
using 'br/public:res/db-for-postgre-sql/flexible-server:<version>'
...
| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`administratorLogin`](#parameter-administratorlogin) | string | The administrator login name of the server. Can only be specified when the PostgreSQL server is being created. Setting AdministratorLogin will result in non-compliancy. |
| [`administratorLoginPassword`](#parameter-administratorloginpassword) | securestring | The administrator login password. Setting administratorLoginPassword will result in non-compliancy. |
| [`administrators`](#parameter-administrators) | array | The Azure AD administrators when AAD authentication enabled. This is the only copmliant authentication method. |
...
| [`configurations`](#parameter-configurations) | array | The configurations to create in the server. Default and compliant configuration includes:<p>{<p>  name: 'require_secure_transport'<p>  source: 'user-override'<p>  value: 'ON'<p>}<p>{<p>  name: 'ssl_min_protocol_version'<p>  source: 'user-override'<p>  value: 'TLSv1.2'<p>}<p> |
...
| [`enableAdvancedThreatProtection`](#parameter-enableadvancedthreatprotection) | bool | Enable/Disable advanced threat protection. Compliant usage requires this option be True. |
...
| [`highAvailability`](#parameter-highavailability) | string | The mode for high availability. Default ZoneRedundant. Compliant usage requires ZoneRedundant. |
...
| [`publicNetworkAccess`](#parameter-publicnetworkaccess) | string | Determines whether or not public network access is enabled or disabled. Compliant (and recommended) usage requires this to be enabled. |
...
| [`serverThreatProtection`](#parameter-serverthreatprotection) | string | Specifies the state of the Threat Protection, whether it is enabled or disabled or a state has not been applied yet on the specific server. Compliant usage requires this to be enabled. |
...
| [`version`](#parameter-version) | string | PostgreSQL Server version. Version lower than 16 will result in non-compliancy |
...
The administrator login name of the server. Can only be specified when the PostgreSQL server is being created. Setting AdministratorLogin will result in non-compliancy.
...
The administrator login password. Setting administratorLoginPassword will result in non-compliancy.
...
The Azure AD administrators when AAD authentication enabled. This is the only copmliant authentication method.
...
The configurations to create in the server. Default and compliant configuration includes:<p>{<p>  name: 'require_secure_transport'<p>  source: 'user-override'<p>  value: 'ON'<p>}<p>{<p>  name: 'ssl_min_protocol_version'<p>  source: 'user-override'<p>  value: 'TLSv1.2'<p>}<p>
...
| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`name`](#parameter-configurationsname) | string | Name of the configuration parameter. |
| [`source`](#parameter-configurationssource) | string | Source of the configuration value. |
| [`value`](#parameter-configurationsvalue) | string | Value of the configuration parameter. |
...
| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`name`](#parameter-databasesname) | string | Name of the database. |

**Optional parameters**

| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`charset`](#parameter-databasescharset) | string | Charset of the database. For example: 'UTF8'  |
| [`collation`](#parameter-databasescollation) | string | Collation of the database. For example: 'en_US.utf8'  |
...
### Parameter: `databases.charset`

Charset of the database. For example: 'UTF8' 
...
Collation of the database. For example: 'en_US.utf8' 
...
Enable/Disable advanced threat protection. Compliant usage requires this option be True.
...
The mode for high availability. Default ZoneRedundant. Compliant usage requires ZoneRedundant.
...
- Required: No
- Type: string
- Default: `'/subscriptions/44fc7c46-cf47-4a29-aaa4-3e30f9e4e14b/resourceGroups/h01-p1-infrastructure-azuredns/providers/Microsoft.Network/privateDnsZones/private.postgres.database.azure.com'`
...
Determines whether or not public network access is enabled or disabled. Compliant (and recommended) usage requires this to be enabled.
...
Specifies the state of the Threat Protection, whether it is enabled or disabled or a state has not been applied yet on the specific server. Compliant usage requires this to be enabled.
...
PostgreSQL Server version. Version lower than 16 will result in non-compliancy
