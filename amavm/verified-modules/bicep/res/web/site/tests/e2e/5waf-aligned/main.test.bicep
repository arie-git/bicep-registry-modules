...
metadata description = 'This instance deploys the Web App in alignment with the best-practices of the Azure Well-Architected Framework.'
...
param serviceShort string = 'wafwapp'
