# Azure Databricks Access Connector `[Microsoft.Databricks/accessConnectors]`
...
There are no special compliance requirements for this resource.
...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/databricks/access-connector:<version>`.
...
```bicep
module accessConnectorMod 'br/<registry-alias>:res/databricks/access-connector:<version>' = {
  name: 'accessConnector-mod'
  params: {
    // Required parameters
    name: 'dac-min001'
...
```bicep-params
using 'br/public:res/databricks/access-connector:<version>'

// Required parameters
param name = 'dac-min001'
// Non-required parameters
