...
Private endpoints to other subscriptions are not allowed by default.
...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/network/private-endpoint:<version>`.
...
```bicep
module privateEndpointMod 'br/<registry-alias>:res/network/private-endpoint:<version>' = {
  name: 'privateEndpoint-mod'
  params: {
    // Required parameters
    name: 'defpep001'
...
```bicep-params
using 'br/public:res/network/private-endpoint:<version>'

// Required parameters
param name = 'defpep001'
...
module privateEndpointMod 'br/<registry-alias>:res/network/private-endpoint:<version>' = {
  ...
  params: {
    ...
    customNetworkInterfaceName: 'maxpep001nic'
    ipConfigurations: [
      {
        name: 'myIPconfig'
        properties: {
...
param customNetworkInterfaceName = 'maxpep001nic'
...
module privateEndpointMod 'br/<registry-alias>:res/network/private-endpoint:<version>' = {
  ...
  params: {
    ...
    customNetworkInterfaceName: 'wafpep001nic'
    ipConfigurations: [
      {
        name: 'myIPconfig'
        properties: {
...
// Required parameters
param name = 'wafpep001'
param subnetResourceId = '<subnetResourceId>'
// Non-required parameters
param applicationSecurityGroupResourceIds = [
  '<applicationSecurityGroupResourceId>'
]
param customNetworkInterfaceName = 'wafpep001nic'
param ipConfigurations = [
  {
    name: 'myIPconfig'
    properties: {
