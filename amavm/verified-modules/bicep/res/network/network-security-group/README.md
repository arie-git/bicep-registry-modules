...
There are no special compliance requirements.
...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/network/network-security-group:<version>`.
...
```bicep
module networkSecurityGroupMod 'br/<registry-alias>:res/network/network-security-group:<version>' = {
  name: 'networkSecurityGroup-mod'
  params: {
    // Required parameters
    name: 'nsg-min001'
...
```bicep-params
using 'br/public:res/network/network-security-group:<version>'

// Required parameters
param name = 'nsg-min001'
// Non-required parameters
...
| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`diagnosticSettings`](#parameter-diagnosticsettings) | array | The diagnostic settings of the service.<p><p>Available log categories: 'NetworkSecurityGroupEvent', 'NetworkSecurityGroupRuleCounter'  |
...
The diagnostic settings of the service.<p><p>Available log categories: 'NetworkSecurityGroupEvent', 'NetworkSecurityGroupRuleCounter' 

- Required: No
- Type: array
- Example: `Available log categories: 'NetworkSecurityGroupEvent', 'NetworkSecurityGroupRuleCounter'`
