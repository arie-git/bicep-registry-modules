...
resource savedSearch 'Microsoft.OperationalInsights/workspaces/savedSearches@2023-09-01' = {
  ...
  properties: {
    #disable-next-line BCP037 // This is a false positive, the 'etag' property works here even if the documentation suggests that it sohuld be placed one level higher.
    etag: etag
    tags: tags ?? []
