...
Compliant usage of Azure Key-Vault requires:
- skuName: 'premium'
...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/key-vault/vault:<version>`.
...
```bicep
module vaultMod 'br/<registry-alias>:res/key-vault/vault:<version>' = {
  name: 'vault-mod'
  params: {
    // Required parameters
    name: 'kvvmin002'
...
```bicep-params
using 'br/public:res/key-vault/vault:<version>'
...
| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`accessPolicies`](#parameter-accesspolicies) | array | All access policies to create.<p><p>Configuring Access Policies on key vault will make the key-vault resource non-compliant.<p> |
...
| [`diagnosticSettings`](#parameter-diagnosticsettings) | array | The diagnostic settings of the service.<p><p>Currently known available log categories are:<p>'AuditEvent'<p>'AzurePolicyEvaluationDetails'<p> |
| [`enablePurgeProtection`](#parameter-enablepurgeprotection) | bool | Provide 'true' to enable Key Vault\'s purge protection feature.<p><p>Setting this parameter value to 'false' will make the resource non-compliant.<p> |
| [`enableRbacAuthorization`](#parameter-enablerbacauthorization) | bool | Property that controls how data actions are authorized. When true, the key vault will use Role Based Access Control (RBAC) for authorization of data actions, and the access policies specified in vault properties will be ignored.<p>When false, the key vault will use the access policies specified in vault properties, and any policy stored on Azure Resource Manager will be ignored. Note that management actions are always authorized with RBAC.<p><p>Setting this parameter value to 'false' will make the resource non-compliant.<p> |
| [`enableSoftDelete`](#parameter-enablesoftdelete) | bool | Switch to enable/disable Key Vault\'s soft delete feature.<p><p>Setting this parameter to false is not supported for new Key Vault deployments in Azure anymore.<p> |
...
| [`publicNetworkAccess`](#parameter-publicnetworkaccess) | string | Whether or not public network access is allowed for this resource. For security reasons it should be disabled. If not specified, it will be disabled by default if private endpoints are set and networkAcls are not set.<p><p>Setting this parameter to any other than Disabled will make the key-vault resource non-compliant.<p> |
| [`roleAssignments`](#parameter-roleassignments) | array | Array of role assignments to create. |
| [`secrets`](#parameter-secrets) | array | All secrets to create. |
| [`sku`](#parameter-sku) | string | Specifies the SKU for the vault.<p><p>Setting this parameter to any other than Premium will make the key-vault resource non-compliant.<p> |
| [`softDeleteRetentionInDays`](#parameter-softdeleteretentionindays) | int | softDelete data retention days. It accepts >=7 and <=90.<p><p>Setting this parameter value to to less than 7 or greater than 90 or null will make the resource non-compliant.<p> |
...
All access policies to create.<p><p>Configuring Access Policies on key vault will make the key-vault resource non-compliant.<p>
...
The diagnostic settings of the service.<p><p>Currently known available log categories are:<p>'AuditEvent'<p>'AzurePolicyEvaluationDetails'<p>
...
Provide 'true' to enable Key Vault\'s purge protection feature.<p><p>Setting this parameter value to 'false' will make the resource non-compliant.<p>
...
Switch to enable/disable Key Vault\'s soft delete feature.<p><p>Setting this parameter to false is not supported for new Key Vault deployments in Azure anymore.<p>
...
Specifies the SKU for the vault.<p><p>Setting this parameter to any other than Premium will make the key-vault resource non-compliant.<p>
...
softDelete data retention days. It accepts >=7 and <=90.<p><p>Setting this parameter value to to less than 7 or greater than 90 or null will make the resource non-compliant.<p>
...
| `keys` | array | The array of created keys. |
| `location` | string | The location the resource was deployed into. |
| `name` | string | The name of the key vault. |
| `properties` | object | The properties of the Key-Vault. |
...
| `secrets` | array | The array of created secrets. |
