...
@description('Optional. The immutability period for the blobs in the container since the policy creation, in days. Default: 365.')
param immutabilityPeriodSinceCreationInDays int = 365

@description('''Optional. This property can only be changed for unlocked time-based retention policies.
...
This property cannot be changed with ExtendImmutabilityPolicy API. Default: true''')
...
Only new blocks can be added and any existing blocks cannot be modified or deleted. This property cannot be changed with ExtendImmutabilityPolicy API.
The "allowProtectedAppendWrites" and "allowProtectedAppendWritesAll" properties are mutually exclusive. Default: true''')
...
@export()
type immutabilityPolicyPropertiesType = {
