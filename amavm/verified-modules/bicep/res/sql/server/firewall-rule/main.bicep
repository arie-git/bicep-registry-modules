...
type firewallRuleType = {
  ...
  @description('''Optional. The end IP address of the firewall rule. Must be IPv4 format.
  Must be greater than or equal to startIpAddress. Use value \'0.0.0.0\' for all Azure-internal IP addresses.''')
  endIpAddress: string?

  @description('''Optional. The start IP address of the firewall rule. Must be IPv4 format.
