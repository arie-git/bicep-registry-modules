...
param serviceShort string = 'audsqlsrv'
...
module nestedDependencies1 '../waf-aligned/dependencies.bicep' = {
  scope: resourceGroup
  name: '${uniqueString(deployment().name, resourceLocation)}-nestedDependencies'
  params: {
...
module testDeployment '../../../main.bicep' = [
  for iteration in ['init', 'idem']: {
    ...
    params: {
      ...
      privateEndpoints: [
        {
          subnetResourceId: nestedDependencies1.outputs.privateEndpointSubnetResourceId
        }
      ]
      auditSettings: {
        state: 'Enabled'
