...
Compliant usage of App Configuration requires:
...
>**Note**: To reference the module, please use the following syntax `br/<registry-alias>:res/app-configuration/configuration-store:<version>`.
...
```bicep
module configurationStoreMod 'br/<registry-alias>:res/app-configuration/configuration-store:<version>' = {
  name: 'configurationStore-mod'
  params: {
    // Required parameters
    name: 'accmin001'
...
```bicep-params
using 'br/public:res/app-configuration/configuration-store:<version>'
...
| [`diagnosticSettings`](#parameter-diagnosticsettings) | array | The diagnostic settings of the service.<p><p>Available options for log categories are: 'HttpRequest', 'Audit'<p> |
| [`disableLocalAuth`](#parameter-disablelocalauth) | bool | Disables all authentication methods other than AAD authentication.<p><p>Setting this parameter to 'false' will make the resource non-compliant<p> |
...
The diagnostic settings of the service.<p><p>Available options for log categories are: 'HttpRequest', 'Audit'<p>
...
Disables all authentication methods other than AAD authentication.<p><p>Setting this parameter to 'false' will make the resource non-compliant<p>
...
| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`name`](#parameter-keyvaluesname) | string | Name of the configuration key. |
| [`value`](#parameter-keyvaluesvalue) | string | The value of the key-value. |

**Optional parameters**

| Parameter | Type | Description |
| :-- | :-- | :-- |
| [`contentType`](#parameter-keyvaluescontenttype) | string | The content type of the key-values value. Providing a proper content-type can enable transformations of values when they are retrieved by applications. |
| [`tags`](#parameter-keyvaluestags) | object | Tags of the resource. |

### Parameter: `keyValues.name`
...
### Parameter: `keyValues.contentType`
...
Whether or not public network access is allowed for this resource. For security reasons it should be disabled. If not specified, it will be disabled by default if private endpoints are set.<p><p>Setting this parameter to 'Enabled' will make the resource non-compliant.<p>
